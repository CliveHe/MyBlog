...
<head>
    ...
    <link rel="canonical" href="http://cliveh.cn/tags/">
...
<style type="text/css">
    header.intro-header {
        background-image: url('${pageContext.request.contextPath}/img/header_img/tag.jpg')
        /*page*/
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <div class="site-heading">
                        ...
                        <!-- <span class="subheading">Hey, this is Tags.</span> -->
                    </div>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            ...
            <div id="tag_cloud" class="tags">
                ...
                <a href="#" title="Show All" rel="${tagCount}">
                    Show All
                    <sup>${tagCount}</sup></sup>
                </a>
            ...
            <!-- 标签列表 -->
            <c:forEach items="${articlesOnTag}" var="tag">
                ...
                <span class="fa fa-tag listing-seperator" id="${tag.tagName}">
                    ...
                    <!-- 标签下的文章列表 -->
                    <c:forEach items="${tag.articles}" var="article">
