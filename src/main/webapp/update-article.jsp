...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="${pageContext.request.contextPath}/updateArticle?articleId=${article.id}" method="post" class="add-article-form">
                <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="article-author" name="articleAuthor" class="form-control" placeholder="在此处输入作者" value="${article.articleAuthor}" required autofocus autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="editormd" id="my-editormd">
                            <!-- 书写与实时显示的textarea -->
                            <textarea name="my-editormd-markdown-doc" style="display:none;">${article.markdown}
                            </textarea>
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <textarea class="form-control" name="articleAbstract" autocomplete="off">${article.articleAbstract}</textarea>
                ...
                <div class="col-md-3">
                        ...
                        <script>
                            $.get("tags?isJson=true",function (data) {
                                ...
                                $.each(arr,function (index,tag) {
                                    item += "<li>\n" +
                                        "<label>\n" +
                                        "<input id=\'"+tag.tagId+"\' class='checkbox' name=\"tags\" type=\"checkbox\" value=\'"+tag.tagId+"\'>\n" +
                                        tag.tagName +
                        ...
                        <script>
                            $(function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    tagsArr.push("${tags.tagId}");
                                    </c:forEach>

                                    $.each(tagsArr, function (i,tagId) {
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <input type="text" class="form-control" value="${article.articleImageUrl}" placeholder="/img/article_header/article_bg.jpg" id="pictureUpload" name="articleImageUrl" autocomplete="off">
                        </div>
                        <div class="add-article-box-footer">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            ...
                            <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="publishDate" autocomplete="off" value="${article.publishDate}" /></span></p>
                        </div>
                        <div class="add-article-box-footer">
