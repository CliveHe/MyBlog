...
<section class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="${pageContext.request.contextPath}/home" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-1 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-11 col-md-offset-1 main" id="main">

                <h1 class="page-header">操作</h1>
                <ol class="breadcrumb">
                    <li><a href="${pageContext.request.contextPath}/add-article.jsp">增加文章</a></li>
                </ol>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th><span class="glyphicon glyphicon-sort-by-order-alt"></span> <span class="visible-lg">ID</span></th>
                        ...
                        <c:forEach items="${pageInfo.list}" var="article">
                            <tr>
                                ...
                                <td><a href="${pageContext.request.contextPath}/findArticleAndMarkdownById?articleId=${article.id}">修改</a>
                                    <a id="delArticle" rel="${article.id}" href="${pageContext.request.contextPath}/deleteArticle?id=${article.id}" onclick="javascript: return confirm('此操作不可逆，是否确认？');">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <footer class="message_footer">
                    <nav>
                        <div class="btn-toolbar operation" role="toolbar">
                            ...
                            <div class="btn-group" role="group">
                                <button id="del_select_btn" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="删除全部选中" name="checkbox_delete">删除</button>
                            </div>
                        </div>
                        <ul class="pagination pagenav">
                            ...
                            <c:if test="${currentPage  <= 1}">
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/manageArticle?pageNo=${currentPage - 1}"
                                       aria-label="Previous" class="disabled">
                            ...
                            <c:forEach var="index" begin="1" end="${totalPage}">
                                <c:if test="${currentPage == index}">
                                    <li class="active"><a
                                            href="${pageContext.request.contextPath}/manageArticle?pageNo=${index}">${index}</a>
                                    </li>
                                </c:if>

                                <c:if test="${currentPage != index}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/manageArticle?pageNo=${index}">${index}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
...
<script>
    ...
    var url1 = strings[strings.length-1].split("?");
    var url2 = url1[1];
    var url3 = url2.split("=");
    var currentPage = url3[1];
    var id = $("#delArticle").attr("rel");
    $("#delArticle").attr("href","${pageContext.request.contextPath}/deleteArticle?id="+id+"&currentPage="+currentPage)
</script>
--%>
...
<script>
    ...
    $("#del_select_btn").click(function () {
        ...
        var name = "";
        //遍历被选中的元素,然后把id取出来
        $.each($(".input-control:checked"), function () {
        ...
        //确认删除
        if (confirm("确认删除这" + $(".input-control:checked").length + "篇文章：“" + name + "” " + "吗？")) {
            //发送ajax请求删除
            $.get("deleteArticle", {id: id}, function () {
                //获取当前页面页码
                /*var url = document.URL;
                var strings = url.split("/");
                var url1 = strings[strings.length-1].split("?");
                ...
                //跳转到查询页面
                //window.location.href = "${pageContext.request.contextPath}/manageArticle?pageNo=" + currentPage;
            })
