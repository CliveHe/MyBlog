...
<head>
    ...
    <script>
        window.onload = function () {
            ...
            if (login_msg !== "" &&(urlBox !== getUrl())) {    //登录页面不弹出未登录警告
                alert(login_msg);
            }
...
<div class="container">
    ...
    <div class="col-md-offset-3 col-md-6">
        <form id="form" class="form-signin" action="${pageContext.request.contextPath}/login" method="post">
            <h2 class="form-signin-heading" style="color: rgb(255,255,255)">管理员登录</h2>
            <br>
